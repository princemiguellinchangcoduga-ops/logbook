...
CREATE INDEX IF NOT EXISTS idx_logbook_category ON logbook_entries (category);
...
-- run it by hand:
ALTER TABLE logbook_entries ALTER COLUMN log_date TYPE DATE USING log_date::date;
...
ALTER TABLE logbook_entries ADD COLUMN IF NOT EXISTS category TEXT NOT NULL DEFAULT 'tor';
ALTER TABLE logbook_entries ADD COLUMN IF NOT EXISTS school TEXT NOT NULL DEFAULT '';
ALTER TABLE logbook_entries ADD COLUMN IF NOT EXISTS delivery_method TEXT NOT NULL DEFAULT '';
